...
use digital_asset_types::dao::scopes::asset::{get_token_account_balance, get_token_supply};
...
impl ApiContract for DasApi {
    ...
    async fn get_token_account_balance(
        ...
        get_token_account_balance(&self.db_connection, token_acc_address.to_bytes().to_vec())
            .await
            .map_err(Into::into)
    }
}
